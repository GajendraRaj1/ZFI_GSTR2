...
define view entity ZI_PO_MASTER_MI_MI as select distinct from I_SuplrInvcItemPurOrdRefAPI01 as SupplierInvoicePORef
  ...
  //                                                                             and SupplierInvoicePORef.PurchaseOrderItem = POItemPricing2.PurchaseOrderItem
  //  //                                                                           and POItemPricing2.ConditionType           = 'ZCES'
  association [0..1] to ZI_JOURNALENTRYITEM1_MI_MI           as JournalItem   on  JournalItem.ReferenceDocumentMIRO = SupplierInvoicePORef.SupplierInvoice
                                                                        and JournalItem.ReferenceDocumentItem = SupplierInvoicePORef.SupplierInvoiceItem
                                                                     //   and 
