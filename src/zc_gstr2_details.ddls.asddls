...
@Metadata.allowExtensions: true
 //define view ZC_GSTR2_DETAILS
 //  as select from zi_send_gstr1_mi as Purchase_Register
define root view entity ZC_GSTR2_DETAILS as projection on
 ZI_SEND_GSTR1_DATA_MI as Purchase_Register 
...
//      @EndUserText.label: 'Reconciliation Action'   "hp
//       Purchase_Register.reco_action,

//      @EndUserText.label: 'Reverse Response'   "hp
...
//      @Consumption.valueHelpDefinition: [{entity: {element: 'PurchasingDocument' , name: 'ZI_SEND_GSTR1_MI' }}]
...
//      Purchase_Register.Discount,
      ...
      @EndUserText.label: 'Profit Cenetr'
           ...
           Reverse,
          @EndUserText.label: 'InvestmentProfile'
           InvestmentProfile,
...
//           @EndUserText.label: 'revrseretensionpostingdocno'  "hp
//           revrseretensionpostingdocno,
           
//           @EndUserText.label: 'Retension Posting Document'   "hp
