...
define view entity ZI_JOURNALENTRYITEM1_MI_MI as select from I_JournalEntryItem as JournalItem
...
@Semantics.amount.currencyCode: 'Comp_currency'
...
//  and JournalItem.GLAccountType = 'P'
 and JournalItem.GLAccount <> '0066000130'
  ...
  group by JournalItem.AccountingDocument, JournalItem.PurchasingDocument,
           JournalItem.FiscalYear, JournalItem.PostingDate,
           JournalItem.OffsettingAccount, JournalItem.PurchasingDocumentItem,
           JournalItem.DebitCreditCode, JournalItem.ReferenceDocument,
           JournalItem.ReferenceDocumentItem, JournalItem.TaxCode, 
